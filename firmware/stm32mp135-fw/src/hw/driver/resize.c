...
__attribute__((optimize("O3"))) void resizeImageFast(resize_image_t *src, resize_image_t *dest)
{
  int destw = dest->w;
  int desth = dest->h;
  int i, j;
...
__attribute__((optimize("O3"))) void resizeImageFastGray(resize_image_t *src, resize_image_t *dest)
{
  int destw = dest->w;
  int desth = dest->h;
  int i, j;
...
__attribute__((optimize("O3"))) void resizeImageNearest(resize_image_t *src, resize_image_t *dest)
{
...
__attribute__((optimize("O3"))) void resizeImageFastGray8(resize_image_t *src, resize_image_t *dest)
{
  int destw = dest->w;
  int desth = dest->h;
  int i, j;
...
__attribute__((optimize("O3"))) void resizeImageNearest8(resize_image_t *src, resize_image_t *dest)
{
  int x_ratio = (int)((src->w<<16)/dest->w) +1;
  int y_ratio = (int)((src->h<<16)/dest->h) +1;
  int x2, y2;
